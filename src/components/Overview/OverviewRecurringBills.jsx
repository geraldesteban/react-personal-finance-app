    ...
    <div className="flex-1 bg-white p-10 rounded-xl lg:p-5">
      ...
      <div>
        <div className="flex relative justify-between items-center bg-beige-100 rounded-xl py-5 mb-5">
          ...
          <h2 className="text-grey-500 text-[14px] font-semibold ml-4">
            Paid Bills
          </h2>
          <p className="text-grey-900 text-[14px] font-bold mr-5">$190.00</p>
        </div>
        <div className="flex relative justify-between items-center bg-beige-100 rounded-xl py-5 mb-5">
          ...
          <p className="text-grey-900 text-[14px] font-bold mr-5">$194.98</p>
        </div>
        <div className="flex relative justify-between items-center bg-beige-100 rounded-xl py-5">
          ...
          <p className="text-grey-900 text-[14px] font-bold mr-5">$59.98</p>
        </div>
      </div>
    </div>
  );
