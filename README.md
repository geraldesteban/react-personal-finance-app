...
- Pots
  - Adding money to a pot should deduct the given amount from the current balance (seen on the Overview page). Current Balance - Added Money Pot
  - Withdrawing money from a pot should add that amount to the current balance. Current Balance + Withdraw
  - Deleting a pot should return all the money from the pot to the current balance. Current Balance + Pot Money
- Recurring Bills
